...
#define AT3D_MMIO_REG_LIST(X)                 \
    ...
    X(AT3D_PCI_VDENDOR_ID, 0x180)             \
    X(AT3D_PCI_DEVICE_ID, 0x182)              \
    X(AT3D_PCI_COMMAND, 0x184)                \
    X(AT3D_PCI_STATUS, 0x186)                 \
    X(AT3D_PCI_REVISION, 0x188)               \
    X(AT3D_PCI_CLASS, 0x189)                  \
    X(AT3D_PCI_MEMORY_BASE, 0x190)            \
    X(AT3D_PCI_IO_BASE, 0x194)                \
    X(AT3D_PCI_SUBSYSTEM_VENDORID, 0x1AC)     \
    X(AT3D_PCI_SUBSYSTEM_ID, 0x1AE)           \
    X(AT3D_PCI_ROM_BASE, 0x1B0)               \
    X(AT3D_PCI_INT_LINE, 0x1BC)               \
    X(AT3D_PCI_INT_PIN, 0x1BD)                \
    X(AT3D_PCI_ENABLE_WRITE_SUBSYS_ID, 0x1C0) \
    X(AT3D_PCI_MAX_GRANT, 0x1BF)              \
    X(GPIO_CTRL, 0x1F0)                       \
