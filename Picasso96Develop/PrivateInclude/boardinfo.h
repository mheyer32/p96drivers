...
/* registerized parameters */
  ...
  #else
    #define ASM __asm
    #define __REGD0(x)  register __d0 x
    #define __REGD1(x)  register __d1 x
    #define __REGD2(x)  register __d2 x
    #define __REGD3(x)  register __d3 x
    #define __REGD4(x)  register __d4 x
    #define __REGD5(x)  register __d5 x
    #define __REGD6(x)  register __d6 x
    #define __REGD7(x)  register __d7 x
    #define __REGA0(x)  register __a0 x
    #define __REGA1(x)  register __a1 x
    #define __REGA2(x)  register __a2 x
    #define __REGA3(x)  register __a3 x
    #define __REGA4(x)  register __a4 x
    #define __REGA5(x)  register __a5 x
    #define __REGA6(x)  register __a6 x
    #define __REGA7(x)  register __a7 x
  #endif
#endif
