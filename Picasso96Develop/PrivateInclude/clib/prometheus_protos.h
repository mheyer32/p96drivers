...
/*
**	$VER: prometheus_protos.h 2.0 (2.1.2002)
**
...
VOID Prm_GetBoardAttrsTagList(PCIBoard *board, struct TagItem* taglist);
VOID Prm_GetBoardAttrsTags(PCIBoard *board, Tag tag1, ...);
