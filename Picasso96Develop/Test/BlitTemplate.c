...
char	ScreenTitle[] = "Picasso96 BlitTemplate Test";
WORD	Pens[] = {~0};
...
main(void)
{
	...
	if(INVALID_ID != (DisplayID = p96RequestModeIDTags(TAG_DONE))){
		...
		if(sc=OpenScreenTags(NULL,
									SA_DisplayID,DisplayID,SA_Depth,4,SA_Width,640,SA_Height,480,SA_Pens,Pens,SA_FullPalette,TRUE,SA_Title,(ULONG)ScreenTitle,SA_Colors32,ColorTable,TAG_DONE)){
