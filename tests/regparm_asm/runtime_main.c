...
extern ULONG ASM rp_cxx_d7_enum_calc_bpr(
    __REGA0(APTR bi), __REGD0(ULONG width), __REGD1(ULONG height), __REGA1(APTR mi),
    __REGD7(RP_RGBFTYPE format));
extern ULONG ASM rp_cxx_d7_ulong_calc_bpr(
    __REGA0(APTR bi), __REGD0(ULONG width), __REGD1(ULONG height), __REGA1(APTR mi),
    __REGD7(ULONG format));
extern ULONG ASM rp_cxx_d7_enum_set_panning(
    __REGA0(APTR bi), __REGA1(APTR mem), __REGD0(UWORD width), __REGD1(WORD x),
    __REGD2(WORD y), __REGD7(RP_RGBFTYPE format));
extern ULONG ASM rp_c_d7_enum_calc_bpr(
    __REGA0(APTR bi), __REGD0(ULONG width), __REGD1(ULONG height), __REGA1(APTR mi),
    __REGD7(RP_RGBFTYPE format));
...
typedef ULONG ASM (*ProbeCalcBprEnumFn)(
    __REGA0(APTR bi), __REGD0(ULONG width), __REGD1(ULONG height), __REGA1(APTR mi),
    __REGD7(RP_RGBFTYPE format));
typedef ULONG ASM (*ProbeCalcBprUlongFn)(
    __REGA0(APTR bi), __REGD0(ULONG width), __REGD1(ULONG height), __REGA1(APTR mi),
    __REGD7(ULONG format));
typedef ULONG ASM (*ProbeSetPanningEnumFn)(
    __REGA0(APTR bi), __REGA1(APTR mem), __REGD0(UWORD width), __REGD1(WORD x),
    __REGD2(WORD y), __REGD7(RP_RGBFTYPE format));
...
int main(void)
{
    ...
    known_fail("C++ d7 enum single (direct)", rp_cxx_d7_enum_single((RP_RGBFTYPE)SENTINEL),
               SENTINEL);
    report("C++ d7 ulong single (direct)", rp_cxx_d7_ulong_single(SENTINEL), SENTINEL);
    report("C d7 enum calc_bpr (direct)",
           rp_c_d7_enum_calc_bpr(dummy, 640, 480, dummy, (RP_RGBFTYPE)SENTINEL), SENTINEL);
    known_fail("C++ d7 enum calc_bpr (direct)",
               rp_cxx_d7_enum_calc_bpr(dummy, 640, 480, dummy, (RP_RGBFTYPE)SENTINEL), SENTINEL);
    report("C++ d7 ulong calc_bpr (direct)",
           rp_cxx_d7_ulong_calc_bpr(dummy, 640, 480, dummy, SENTINEL), SENTINEL);

    {
        ProbeCalcBprEnumFn fn = rp_cxx_d7_enum_calc_bpr;
        known_fail("C++ d7 enum calc_bpr (fn ptr)",
                   fn(dummy, 640, 480, dummy, (RP_RGBFTYPE)SENTINEL), SENTINEL);
    }
    {
    ...
    }
    {
        ...
        known_fail("C++ d7 enum set_panning (fn ptr)",
                   fn(dummy, dummy, 640, 0, 0, (RP_RGBFTYPE)SENTINEL), SENTINEL);
    }
    {
