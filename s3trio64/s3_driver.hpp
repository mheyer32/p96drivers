...
class S3Driver : public P96Driver
{
   public:
	...
	void performBlitPlanar2ChunkyBlits(SHORT dstX, SHORT dstY, SHORT width, SHORT height, UWORD mixMode, UBYTE *bitmap, UWORD dwordsPerLine, WORD bmPitch, UBYTE rol);
